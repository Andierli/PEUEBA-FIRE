...
tl_admin_users = ['Andi9919','Alucard931121',''] #Poner aqui los user con acceso permanente
godlist = ['Andi9919','Alucard931121',''] #Poner aqui los admin 
...
async def onmessage(bot:TelegramClient,ev: NewMessage.Event,loop,ret=False):
    ...
    if '/up' in text:
        ...
        try:
            await bot.edit_message(ev.chat,message,text=f'📯Obteniendo acceso...')
